...
namespace AuctionHunter.G2A.Implementation
{
	...
	{
		public static string DefaultBaseUrl => "https://www.g2a.com/new/api/v1/products/filter?category_id=games&changeType=PAGINATION&currency=PLN&min_price[max]=100&min_price[min]=0&page=&platform=1&store=polish";
